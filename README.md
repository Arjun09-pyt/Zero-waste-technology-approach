...
<body>
  ...
  <script>
    ...
    function rgbToHsl(r,g,b){
      ...
      let h=0,s=0,l=(max+mi[index (2).html](https://github.com/user-attachments/files/24687170/index.2.html)
[!doctype html.txt](https://github.com/user-attachments/files/24687167/doctype.html.txt)
n)/2;
